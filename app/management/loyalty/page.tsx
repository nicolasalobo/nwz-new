    ...
    return (
        <div className="min-h-screen w-full bg-[#020617] text-white flex flex-col items-center justify-center p-6">
            ...
            <div className="max-w-md w-full text-center space-y-6">
                ...
                <h1 className="text-3xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-rose-400 to-pink-400">
                    Programa de Fidelidade
                </h1>

                <p className="text-zinc-400">
                    Aqui você poderá gerenciar pontos e recompensas dos clientes.
                </p>
